...
/* package lock-server-0.1.0.0 */
#define VERSION_lock_server "0.1.0.0"
#define MIN_VERSION_lock_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lock-server-0.1.0.0-6nvmaZgm0jr4RdxCcmLsJq"

#define CURRENT_PACKAGE_KEY "lock-server-0.1.0.0-6nvmaZgm0jr4RdxCcmLsJq"
