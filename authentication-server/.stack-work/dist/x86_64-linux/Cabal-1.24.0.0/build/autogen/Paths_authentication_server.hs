...
module Paths_authentication_server (
    version,
...
libdir     = "/home/dheg/Documents/cs4032-Project/authentication-server/.stack-work/install/x86_64-linux/nightly-2016-12-10/8.0.1/lib/x86_64-linux-ghc-8.0.1/authentication-server-0.1.0.0-IzU5vb9vjCQA9EmYK15YfI"
...
getLibDir = catchIO (getEnv "authentication_server_libdir") (\_ -> return libdir)
getDataDir = catchIO (getEnv "authentication_server_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "authentication_server_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "authentication_server_sysconfdir") (\_ -> return sysconfdir)
